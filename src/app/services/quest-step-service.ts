...
export class QuestStepService {
  ...
  steps: QuestStep[] = [
    ...
    this.questStepFactory.NewQuestStep( '1330', () => this.questFilterService.theRingedCityIsVisible || this.questFilterService.lappIsVisible, 'The Ringed City', questType.boss, [ DSIII_QUEST_TAGS.theRingedCity ]),
